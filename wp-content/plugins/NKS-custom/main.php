...
function nks_cc_menu()
{
    add_options_page(
        'NK: Sliding Panel',
        '<span style="display: inline-block;border-left:3px solid #fdb814; padding-left:3px;position: relative;left: -6px;">NK: Sliding Panel</span>',
        'manage_options',
        'nks-custom-options',
        'nks_cc_page'
    );
